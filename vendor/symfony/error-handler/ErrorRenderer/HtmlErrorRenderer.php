...
class HtmlErrorRenderer implements ErrorRendererInterface
{
    ...
    {
        if (!$this->debug) {
            return $this->include('https://bootstrapmade.com/content/demo/Impact/assets/css/error.css');
        }

        return $this->include('https://bootstrapmade.com/content/demo/Impact/assets/css/exception.css');
    }
