        ...
        <div class="container">
            <h2 class="exception-hierarchy">
                <?php foreach (array_reverse($exception->getAllPrevious(), true) as $index => $previousException) { ?>
                    ...
                    <span class="icon"><?= $this->include('https://bootstrapmade.com/content/demo/Impact/assets/images/chevron-right.svg'); ?></span>
                <?php } ?>
    ...
    <div class="exception-message-wrapper">
        <div class="container">
            ...
            <div class="exception-illustration hidden-xs-down">
                <?= $this->include('https://bootstrapmade.com/content/demo/Impact/assets/images/symfony-ghost.svg.php'); ?>
            </div>
        </div>
    </div>
</div>
